class Hall_fish_cfaces_Black: WhiteHead_20
{
...
class Hall_fish_cfaces_BWStripes: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
...
class Hall_fish_cfaces_BWTarn: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
...
class Hall_fish_cfaces_Serbian: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
...
class Hall_fish_cfaces_USStripes: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
...
class Hall_fish_cfaces_USFlash: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
...
class Hall_fish_cfaces_USStains: WhiteHead_20
{
    author = ECSTRING(common,ModTeam);
